    ...
    <div class="grid grid-cols-1 gap-10 md:grid-cols-2">
      <div>
        ...
        <div class="mt-6 flex items-center gap-3 text-sm">
          <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" class="inline-flex items-center gap-2 text-gray-700 hover:text-gray-900">
          ...
          <a href="https://github.com/" target="_blank" rel="noreferrer" class="inline-flex items-center gap-2 text-gray-700 hover:text-gray-900">
          ...
          <a href="mailto:email@example.com" class="inline-flex items-center gap-2 text-gray-700 hover:text-gray-900">
