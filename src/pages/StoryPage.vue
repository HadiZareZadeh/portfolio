      ...
      <div class="flex gap-8">
        ...
        <section id="chapter-5" v-reveal class="mb-12 scroll-mt-24">
          ...
          <div class="space-y-4 text-gray-700 leading-relaxed">
            ...
            <blockquote class="border-l-4 border-brand-600 pl-4 italic text-gray-600 my-4">
        ...
        <section id="chapter-7" v-reveal class="mb-12 scroll-mt-24">
          ...
          <div class="space-y-4 text-gray-700 leading-relaxed">
            ...
            <ol class="list-decimal list-inside space-y-2 ml-4 text-gray-700">
              <li>I always attended other classes in addition to my own (only computer-related courses).</li>
              <li>I usually helped other students learn and solve their exercises.</li>
